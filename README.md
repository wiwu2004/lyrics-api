...
🔄 Processing Flow
The API receives the full lyrics text
The text is split into individual lines (verses)
Each line is cleaned and validated
A structured response is created for each verse
(Future) Each verse will be translated and converted to audio
📁 Project Structure
controller/
service/
dto/
